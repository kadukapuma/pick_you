...
const Vehicles = () => {
    ...
    return (
        <section className="content-page">
            ...
            <DataTable
                headers={['Vehicle / Plate', 'Driver', 'Details', 'Status', 'Year', 'Color', 'Actions']}
                gridTemplate="2fr 1.5fr 1fr 1fr 0.8fr 0.8fr 120px"
                pagination={{
            ...
            >
                {loading ? (
                    <div className="table-row" style={{ gridTemplateColumns: '2fr 1.5fr 1fr 1fr 0.8fr 0.8fr 120px' }}>
                    ...
                    filteredVehicles.map((vehicle) => (
                        <div className="table-row" key={vehicle.id} style={{ gridTemplateColumns: '2fr 1.5fr 1fr 1fr 0.8fr 0.8fr 120px' }}>

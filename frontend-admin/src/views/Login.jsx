...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (require2FA) {
                await verifyAdmin2FA({ phone: form.phone, code: form.code })
                navigate('/')
            } else {
                const response = await signIn({ phone: form.phone, password: form.password })
            ...
            <div className="login-page">
                ...
                <div className="login-right">
                    <div className="login-card">
                        ...
                        <h3>SECURITY</h3>
                        <p className="subtitle">Enter the 4-digit code sent to your phone</p>

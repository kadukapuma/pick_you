...
import { getDriverName, getVehicleDescription, getVehicleNumber, rideTheme } from "../../features/ride-support/rideUtils";
...
export default function DriverProfileScreen() {
  ...
  return (
    <RideScreenShell title="Driver profile" subtitle="Driver and vehicle assigned to this ride.">
      <RideCard>
        <View style={styles.avatar}><Text style={styles.avatarText}>{getDriverName(ride).slice(0, 1).toUpperCase()}</Text></View>
...
const styles = StyleSheet.create({
  avatar: { alignSelf: "center", width: 82, height: 82, borderRadius: 41, backgroundColor: rideTheme.softGreen, alignItems: "center", justifyContent: "center" },

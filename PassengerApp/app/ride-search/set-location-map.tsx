...
import { useRideSearch, LocationSuggestion } from "../../context/RideSearchContext";
  ...
  const handleConfirmDrop = () => {
    ...
    try {
      ...
      if (activeTab === "oneway") {
        setTripType("oneway");
        router.push({
          pathname: "/ride-search/select-ride" as any,
          params: {
        ...
        setTripType("return");
        router.push({
          pathname: "/ride-search/select-ride-return" as any,
          params: {
      ...
      console.error(e);
      Alert.alert("Error", "Failed to select this location.");
    } finally {
      setConfirming(false);
    }
  };
